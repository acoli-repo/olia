# OLiA ontologies (official release page)
...
> OLiA is open source (code: Apache v.2, data: CC-BY 3.0), for terms of use, attribution and detailed documentation, please see [the official website](https://acoli-repo.github.io/olia/).For more detailed information, please see the [website](https://acoli-repo.github.io/olia/)

## Disclaimer

**DO NOT EDIT** the content of this directory, they are automatically created from */owl/* (with ** being the root directory of the repository, equivalent to https://github.com/acoli-repo/olia).

 For more information about how to build and update the public OLiA ontologies, run
    $> cd $ROOT
    $> make help

Note: Use the root directory of your local copy of the the repository.
